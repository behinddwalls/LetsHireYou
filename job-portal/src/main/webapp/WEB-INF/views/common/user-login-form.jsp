...
<form:form action="${contextPath}/signin/jobseeker" method="post"
	...
	<div class="form-group">
		<label for="forgot-password">Forgot Password</label> <a
			...
			href="${contextPath}/signin/jobseeker/forgot-password">Forgot
			Password</a>
	</div>
	<hr>
	<div class="form-group">
		...
		<c:choose>
			...
			<c:otherwise>
				<a class="btn btn-primary link-register">Sign Up</a>
			</c:otherwise>
		</c:choose>
	</div>
</form:form>
