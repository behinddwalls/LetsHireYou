	...
	<div class="container">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="${contextPath}/jobseeker/profile/view">My
						Profile</a></li>
				...
				<li class="dropdown hidden-xs"><a href="#"
					...
					<ul class="dropdown-menu">
						<li><a href="${contextPath}/jobseeker/job/recommendedjob">Recommended
								Job</a></li>
						<li><a href="${contextPath}/jobseeker/job/viewjob">My
								Jobs</a></li>
