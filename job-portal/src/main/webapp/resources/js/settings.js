            ...
            .ready(
                    function() {
                        ...
                        $(".link-recruiter-login").click(function() {
                            $("#recruiter-login").fadeIn(300);
                            $("body").addClass("no-scroll");
                        });

                        $("#recruiter-login .close").click(function() {
                            $("#recruiter-login").fadeOut(300);
                            $("body").removeClass("no-scroll");
                        });
                        ...
                        $(".link-recruiter-register").click(function() {
                            $("#recruiter-register").fadeIn(300);
                            $("body").addClass("no-scroll");
                        });

                        $("#recruiter-register .close").click(function() {
                            $("#recruiter-register").fadeOut(300);
                            $("body").removeClass("no-scroll");
                        });
